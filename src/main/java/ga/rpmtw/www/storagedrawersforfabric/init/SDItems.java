...
public class SDItems
{
    ...
    public static void init()
    {
        ...
        BASIC_IRON_UPGRADE = register("iron_upgrade", new ItemDrawerUpgrade(new Settings().group(SD_GROUP).maxCount(1), Either.right(Border.BorderType.BASIC), Border.IRON_BORDER));
